...
export default function GenerateHomePage(){
    let homepagecontainer = document.createElement("div"); homepagecontainer.setAttribute("id","homepagecontainer")
    let content = document.querySelector("#content")
    let restaurantheader = document.createElement("h2"); restaurantheader.textContent = "Ristorante della Nonna"; restaurantheader.setAttribute("class","homepage-h2")
    ...
    content.append(homepagecontainer); homepagecontainer.append(restaurantheader,maindiv);  maindiv.append(declaration,maintext); 
    console.log("WASSUP!")
}
